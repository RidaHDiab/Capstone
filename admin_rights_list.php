...
$pageMask[$table] = $mask;
$tables[$table] = array("bbc_art", " " . "Bbc Art");
$table = "dbo.jaz_art";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("jaz_art", " " . "Jaz Art");
$table = "dbo.may_art";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("may_art", " " . "May Art");
...
$pageMask[$table] = $mask;
$tables[$table] = array("news_capstone_users", " " . "News Capstone Users");
...
$pageMask[$table] = $mask;
$tables[$table] = array("news_capstone_users_chart", " " . "News Capstone_users Chart");
...
$pageMask[$table] = $mask;
$tables[$table] = array("jaz_art_chart", " " . "Jaz Art Chart");
...
$pageMask[$table] = $mask;
$tables[$table] = array("news_capstone_audit_chart", " " . "news capstone_audit Chart");
$table = "Dashboard";
$mask="";
if( pageEnabled($table, 'view') || pageEnabled($table, 'list') || pageEnabled($table, 'chart') || pageEnabled($table, 'report') || pageEnabled($table, 'dashboard') )
	$mask .= "S";
...
$pageMask[$table] = $mask;
$tables[$table] = array("bbc_art_chart", " " . "Bbc Art Chart");
...
$pageMask[$table] = $mask;
$tables[$table] = array("may_art_chart", " " . "May Art Chart");
