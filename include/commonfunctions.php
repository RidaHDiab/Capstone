...
function checkTableName($shortTName )
{
	...
	if ("bbc_art" == $shortTName )
		return true;
	if ("jaz_art" == $shortTName )
		return true;
	if ("may_art" == $shortTName )
		return true;
	if ("news_capstone_users" == $shortTName )
		return true;
	...
	if ("admin_users" == $shortTName )
		return true;
	if ("news_capstone_users_chart" == $shortTName )
		return true;
	if ("jaz_art_chart" == $shortTName )
		return true;
	if ("news_capstone_audit_chart" == $shortTName )
		return true;
	if ("dashboard" == $shortTName )
		return true;
	if ("bbc_art_chart" == $shortTName )
		return true;
	if ("may_art_chart" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.bbc_art");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.jaz_art");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.may_art");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.News Capstone_users");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.News Capstone_users";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.News Capstone_users Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.News Capstone_users Chart";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.jaz_art Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.jaz_art Chart";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.news capstone_audit Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.news capstone_audit Chart";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.bbc_art Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.bbc_art Chart";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.may_art Chart");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.may_art Chart";
	}
	return $arr;
}
...
{
	if($shorttable=="news_capstone_users_chart")
		return "2DBar";
	if($shorttable=="jaz_art_chart")
		return "2DColumn";
	if($shorttable=="news_capstone_audit_chart")
		return "Line";
	if($shorttable=="bbc_art_chart")
		return "2DColumn";
	if($shorttable=="may_art_chart")
		return "2DColumn";
	return "";
}
...
//	default permissions
	...
	if( $table=="dbo.News Capstone_users" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.News Capstone_users Chart" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.news capstone_audit Chart" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
function GetBaseScriptsForPage($isDisplayLoading, $additionalScripts = "", $customText = "")
{
	...
	$result = "";
	$result .= "<script type=\"text/javascript\" src=\"".GetRootPathForResources("include/loadfirst.js?41242")."\"></script>";


	$result .= $additionalScripts;
	$result .= "<script type=\"text/javascript\" src=\"".GetRootPathForResources("include/lang/".getLangFileName(mlang_getcurrentlang()).".js?41242")."\"></script>";
