...
$tdataadmin_users[".OriginalTable"] = "dbo.News Capstone_users";
...
$tdataadmin_users[".connId"] = "News_at_192_168_1_225";


$tdataadmin_users[".strOriginalTableName"] = "dbo.News Capstone_users";
...
$tdataadmin_users[".sqlHead"] = "SELECT ID,  	username,  	password,  	email,  	fullname,  	groupid,  	active,  	ext_security_id,  	userpic,  	two_factor,  	reset_token,  	reset_date";
$tdataadmin_users[".sqlFrom"] = "FROM dbo.[News Capstone_users]";
