...
class XTempl_Base
{
	 ...
	 function __construct( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("news_capstone_users_chart_chart","xt_showchart",
			array(
				"chartName"=>"news_capstone_users_chart",
				"table"=>"dbo.News Capstone_users Chart",
				"ctype"=>"2DBar"));
			$this->assign_function("jaz_art_chart_chart","xt_showchart",
			array(
				"chartName"=>"jaz_art_chart",
				"table"=>"dbo.jaz_art Chart",
				"ctype"=>"2DColumn"));
			$this->assign_function("news_capstone_audit_chart_chart","xt_showchart",
			array(
				"chartName"=>"news_capstone_audit_chart",
				"table"=>"dbo.news capstone_audit Chart",
				"ctype"=>"Line"));
			$this->assign_function("bbc_art_chart_chart","xt_showchart",
			array(
				"chartName"=>"bbc_art_chart",
				"table"=>"dbo.bbc_art Chart",
				"ctype"=>"2DColumn"));
			$this->assign_function("may_art_chart_chart","xt_showchart",
			array(
				"chartName"=>"may_art_chart",
