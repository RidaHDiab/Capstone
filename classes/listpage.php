...
class ListPage extends RunnerPage
{
	...
	{
		if( postvalue("pageType") == "register" && postvalue("table") == "dbo.News Capstone_users" )
			return new ProjectSettings( "dbo.News Capstone_users", PAGE_REGISTER, "", GLOBAL_PAGES);
	...
	protected static function checkLookupPermissions( $table )
	{
		...
		if( $mainTable == "dbo.News Capstone_users" )
		{
