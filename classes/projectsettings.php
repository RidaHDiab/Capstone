	...
	*/
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("dbo.News Capstone_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "dbo.bbc_art" ] = array( "url" => "bbc_art", "type" => 0 );
	$projectEntitiesReverse[ "bbc_art" ] = "dbo.bbc_art";
	$projectEntities[ "dbo.jaz_art" ] = array( "url" => "jaz_art", "type" => 0 );
	$projectEntitiesReverse[ "jaz_art" ] = "dbo.jaz_art";
	$projectEntities[ "dbo.may_art" ] = array( "url" => "may_art", "type" => 0 );
	$projectEntitiesReverse[ "may_art" ] = "dbo.may_art";
	$projectEntities[ "dbo.News Capstone_users" ] = array( "url" => "news_capstone_users", "type" => 0 );
	$projectEntitiesReverse[ "news_capstone_users" ] = "dbo.News Capstone_users";
	...
	$projectEntities[ "dbo.News Capstone_users Chart" ] = array( "url" => "news_capstone_users_chart", "type" => 3 );
	$projectEntitiesReverse[ "news_capstone_users_chart" ] = "dbo.News Capstone_users Chart";
	$projectEntities[ "dbo.jaz_art Chart" ] = array( "url" => "jaz_art_chart", "type" => 3 );
	$projectEntitiesReverse[ "jaz_art_chart" ] = "dbo.jaz_art Chart";
	$projectEntities[ "dbo.news capstone_audit Chart" ] = array( "url" => "news_capstone_audit_chart", "type" => 3 );
	$projectEntitiesReverse[ "news_capstone_audit_chart" ] = "dbo.news capstone_audit Chart";
	$projectEntities[ "Dashboard" ] = array( "url" => "dashboard", "type" => 4 );
	$projectEntitiesReverse[ "dashboard" ] = "Dashboard";
	$projectEntities[ "dbo.bbc_art Chart" ] = array( "url" => "bbc_art_chart", "type" => 3 );
	$projectEntitiesReverse[ "bbc_art_chart" ] = "dbo.bbc_art Chart";
	$projectEntities[ "dbo.may_art Chart" ] = array( "url" => "may_art_chart", "type" => 3 );
	$projectEntitiesReverse[ "may_art_chart" ] = "dbo.may_art Chart";
}
