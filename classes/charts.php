...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("dbo.bbc_art" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.jaz_art" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.may_art" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.News Capstone_users" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.News Capstoneugrights" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.News Capstoneugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.News Capstone_users" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.News Capstone_users" == $this->chrt_array['tables'][0])
		...
		if("dbo.jaz_art" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.news capstone_audit" == $this->chrt_array['tables'][0])
			return true;
