...
if($buttId=='BBC_REDIRECT')
{
	...
	buttonHandler_BBC_REDIRECT($params);
}
if($buttId=='MAY_REDIRECT')
{
	//  for login page users table can be turned off
	if( $table != GLOBAL_PAGES )
	{
	...
	buttonHandler_MAY_REDIRECT($params);
}
if($buttId=='Request_Update_from_API')
{
	//  for login page users table can be turned off
	if( $table != GLOBAL_PAGES )
	{
	...
	buttonHandler_Request_Update_from_API($params);
}
...
function buttonHandler_BBC_REDIRECT($params)
{
	global $strTableName;
	$result = array();
...
function buttonHandler_MAY_REDIRECT($params)
{
	global $strTableName;
	$result = array();
...
function buttonHandler_Request_Update_from_API($params)
{
	global $strTableName;
	$result = array();
...
$url = 'http://127.0.0.1:5000/start_article_gathering';
