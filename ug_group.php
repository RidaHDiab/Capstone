...
$nonAdminTablesArr[] = "dbo.bbc_art";
$nonAdminTablesArr[] = "dbo.jaz_art";
$nonAdminTablesArr[] = "dbo.may_art";
$nonAdminTablesArr[] = "dbo.News Capstone_users";
$nonAdminTablesArr[] = "dbo.News Capstone_users Chart";
$nonAdminTablesArr[] = "dbo.jaz_art Chart";
$nonAdminTablesArr[] = "dbo.news capstone_audit Chart";
$nonAdminTablesArr[] = "Dashboard";
$nonAdminTablesArr[] = "dbo.bbc_art Chart";
$nonAdminTablesArr[] = "dbo.may_art Chart";
...
$wGroupTableName = $ug_connection->addTableWrappers( "dbo.News Capstoneuggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "dbo.News Capstoneugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "dbo.News Capstoneugrights" );
